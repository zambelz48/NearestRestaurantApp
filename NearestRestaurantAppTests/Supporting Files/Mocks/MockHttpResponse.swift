...
final class MockHttpResponse {
	...
	static func successfulFoursquareVenueDetailURLSession() -> StubURLSession {
		return StubURLSession(statusCode: 200, fakeResponse: FakeJsonData.foursquareVenueDetailJson)
	}
